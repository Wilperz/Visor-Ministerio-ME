Graficas = new function () {
    ...
    this.dibujar_lista_indicadores = function(){
        try{
            ...
            for (var i = 0; i < Graficas._ListaIndicadores.length; i++) {                
                ...
                vTabla += " <tr><td class='txt_verde' >"+vFila[0]+"</td><td style='text-align: center;'><input class='components'  type='checkbox'  id='"+vFila[1]+"' name='"+vFila[1]+"' value='0'></td></tr>";
            }
            ...
            for (var i = 0; i < Graficas._ListaIndicadoresC.length; i++) {                
                ...
                vTabla += " <tr><td class='txt_verde' >"+vFila[0]+" ("+vFila[3]+")</td><td style='text-align: center;'><input class='components'  type='checkbox'  id='"+vFila[1]+"' name='"+vFila[1]+"' value='0'></td></tr>";
            }
    ...
    this.mostrarTabla = function(){
        try{
            ...
            for (var i = 0; i < Graficas._datos.length; i++) {
                ...
                if(i == 0){
                    ...
                    for (var j = 0; j < vItem.length; j++) {
                        var vValor = vItem[j];
                        vEnc += '<td class="header"><b>'+vValor+'</b></td>';
                        if(j>1){
                            vCh += '<td><input class="components"  type="checkbox"  id="g_'+j+'" name="g_'+j+'" value="0" onclick="Graficas.cambioCh('+j+')"></td>';
                        }
                    }
                    vEnc += '	</tr>';
                    vCh += '	</tr>';
                    ...
                    for (var j = 0; j < vItem.length; j++) {
                        var vValor = vItem[j];
                        vFilas += '<td '+((j==0 || j == 1)?' style="text-align:left" ':'')+' >'+vValor+'</td>';
                    }
                    vFilas += '	</tr>';
                }
            ...
            var vTabla = '';
            vTabla += '<table id="TablaIndicadores" style="width: 100%;">';
            vTabla += '<thead>';                               
            vTabla += '	<tr>  ';
